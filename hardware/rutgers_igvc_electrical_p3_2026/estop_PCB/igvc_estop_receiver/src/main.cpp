...
// // STRINGS MIGHT NOT WORK, USE CHAR ARRAY INSTEAD FOR FIXED SIZE
// float s = .04; // sensor sensitivity 
// float f;
// float v0Signal = 8550;
// float fsr = 2048/32768;
...
//   Serial.println(ADS1X15_LIB_VERSION);
//   ADS.begin();
//   ADS.setGain(); // Set gain to 2x for Â±2V range, safe for the ESP32 3.3V logic
// }
...
//     ADSValue = ADS.readADC(3);
//     f = ADS.toVoltage(2);
//     current= (ADSValue-v0Signal)*fsr/s;
